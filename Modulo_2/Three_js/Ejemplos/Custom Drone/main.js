...
const array_motor = [
    {id: 1, text: "motor 1", ruta: "./recursos/model/motor/Motor1.gltf"},
    {id: 2, text: "motor 2", ruta: "./recursos/model/motor/Motor2.gltf"},
    {id: 3, text: "motor 3", ruta: "./recursos/model/motor/Motor3.gltf"}
];

const objeto_base = [
    {id: 1, text4: "base", ruta: "./recursos/model/base/Base.gltf"},

]

const array_helice = [
    {id: 0, text2: "helice 1", ruta: "./recursos/model/helices/Helice1.gltf", name: "helice1"},
    {id: 1, text2: "helice 2", ruta: "./recursos/model/helices/Helice2.gltf", name: "helice2"},
    {id: 2, text2: "helice 3", ruta: "./recursos/model/helices/Helice3.gltf", name: "helice3"}
];

const array_camara = [
    {id: 0, text3: "camara 1",ruta: "./recursos/model/cam/Cam1.gltf"},
    {id: 1, text3: "camara 2",ruta: "./recursos/model/cam/cam2.gltf"},
    {id: 2, text3: "camara 3",ruta: "./recursos/model/cam/cam3.gltf"}
];
...
helice.addEventListener("change", (event) => {
    loadModels(array_helice.find((e) => e.id == event.target.value).ruta, droneParts.helice, 'helice3');
    droneParts.helice.clear();
...
loadModels(array_helice[0].ruta, droneParts.helice, 'helice3');
...
const animate = () => {
    ...
    if (movingUp) {
        ...
        droneParts.helice.position.y += moveSpeed;
        }
    }
